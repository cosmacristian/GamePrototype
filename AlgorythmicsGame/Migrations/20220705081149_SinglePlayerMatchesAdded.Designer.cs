...
namespace AlgorythmicsGame.Migrations
{
    ...
    [Migration("20220705081149_SinglePlayerMatchesAdded")]
    partial class SinglePlayerMatchesAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AlgorythmicsGame.Context.OrganizedMatch", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("OrganizedMatch");
                });
            ...
            modelBuilder.Entity("AlgorythmicsGame.Context.OrganizedMultiMatch", b =>
                {
                    b.HasBaseType("AlgorythmicsGame.Context.OrganizedMatch");

                    b.HasDiscriminator().HasValue("OrganizedMultiMatch");
                });

            modelBuilder.Entity("AlgorythmicsGame.Context.OrganizedSingleMatch", b =>
                {
                    b.HasBaseType("AlgorythmicsGame.Context.OrganizedMatch");

                    b.Property<TimeSpan>("bestTimeRecord");

                    b.HasDiscriminator().HasValue("OrganizedSingleMatch");
                });
