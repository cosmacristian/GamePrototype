...
using AlgorythmicsGame.Models.ManageViewModels;
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> Index(string id = null)
        {
            ...
            List<CourseProgressByUser> startedCoursesFromDb = _context.CourseProgressByUser
                ...
                .Where(x => x.UserId == user.Id && x.Type == Models.Enums.LogEntryType.Step)
                .ToList();
        ...
        public async Task<IActionResult> Edit(EditViewModel model)
        {
            ...
            if (model.ProfileImage != image)
            {
                var setImageResult = await _userManager.SetEmailAsync(user, model.ProfileImage);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> SendVerificationEmail(EditViewModel model)
        {
            if (!ModelState.IsValid)
            {
                return View(model);
        ...
        [HttpGet]
        public async Task<ActionResult> AdvancedOptions()
        {
            var user = await _userManager.GetUserAsync(User);
            if (user == null)
            {
            ...
            return View(nameof(AdvancedOptions));
        }
        ...
        public async Task<IActionResult> DeleteAccount()
        {
            ...
            _logger.LogInformation("User deleted its profile and logged out.");
        ...
        private CourseProgressViewModel GetCourseProgressViewModel(List<CourseProgressViewModel> viewModels, LocalizedCourse course, DateTime date)
        {
            ...
            if (viewModel == null)
            {
                ...
                return new CourseProgressViewModel()
                {
                    ...
                    Date = date,
                    Points = 0,
                    MaximumPoints = course.LearningSteps.Count() * 100
                };
            }
            else
            {
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("Algorythmics"),
